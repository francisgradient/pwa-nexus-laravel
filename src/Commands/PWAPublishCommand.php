...
namespace FrancisLarvelPwa\Commands;
...
class PwaPublishCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'nexus:install-pwa';
